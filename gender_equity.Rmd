...
trend(H_gen_trend, plot_title = "Homeownership by Year", cat = 'sex', y_title = 'Percent',
...
trend(I_CB_earn_trend, cost_burden, rollmean = 3, plot_title = "Homeownership by Year", cat = "earner_type", y_title = 'Percent',
       caption_text = "Source Greater Louisville Project
      Data from GLP analysis of ACS microdata from IPUMS-USA"
     )
