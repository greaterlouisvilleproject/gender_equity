...
save(H_gen_trend, H_singFem_rank, H_sinFem_kids, H_s_m_kids_trend, H_Fem_race, I_CB_earn_trend,
...
#TO DO:
# facet this vertically
# Change the x-axis to a dollar format (see trendline function in trendline_helpers.R)
# Label the x-axis on every $50,000?
# Let's use counts on the y-axis for the male and female graph
...
p <- p + labs(
  title = "Male Single Earner vs Female Single Earner"
)

p <- p + guides(color = FALSE)

p <- p + facet_wrap(~sex, nrow = 2) 
